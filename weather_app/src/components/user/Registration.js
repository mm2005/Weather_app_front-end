...
const Registration = () => {
    ...
    const registrationStyle = {
      ...
      borderRight: "0",
      textAlign: "center",
      backgroundImage: "linear-gradient(160deg, lightblue, lightgrey)"
    };
    const linkStyle = {
      color: "#003464",
      fontSize: "50px",
      ...
      lineHeight: "90px",
      border: "none",
      backgroundImage: "linear-gradient(160deg, lightgrey, lightblue)"
...
if (!success){
  return (
    <div style={registrationStyle}>
        ...
        <br></br><button style={linkStyle} disabled={valid} onClick={createUser}>Register</button>
      </div>
  );
  }
  else {
    return( <div style={registrationStyle}>
    <h1>Successful registration!</h1>
    <Link style={linkStyle} to="/">Go to main...</Link>
    </div>
      )
  }
